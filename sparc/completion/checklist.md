...
- [x] App description written (4000 char max) — *draft in APP_STORE_LISTING.md; pending Greg review*
...
### 11. TestFlight Beta
*Runbook for Greg: [docs/ship/TESTFLIGHT_RUNBOOK.md](../../docs/ship/TESTFLIGHT_RUNBOOK.md). No build has been uploaded.*
...
**Greg performs these steps.** Per standing rule, Scout/agents do not upload or submit builds.
