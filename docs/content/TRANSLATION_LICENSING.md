...
**the owner's decision (issue #22, option 1): v1 ships public-domain scripture only — the World English Bible (WEB, default) and the King James Version (KJV). No ESV, NIV, or NKJV text ships in the v1 bundle.**
...
### Sprint D recommendation (as written; the owner subsequently chose the public-domain path — option 2 below, now implemented)

**Original heading: Decision for the owner (v1): Not cleared to ship as-is**
