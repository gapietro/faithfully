...
| Area | Status | Notes |
|---|---|---|
| Code & tests | 🟢 Ready | 177/177 unit tests green (Sprint F1 run), build clean — [TEST_RUN.md](TEST_RUN.md) |
...
| Translation licensing | 🟢 Ready | Cleared for v1 under the public-domain strategy (Greg's decision, #22); commercial translations deferred to v1.x — [licensing](../content/TRANSLATION_LICENSING.md) |
...
**Bottom line:** the two former red blockers are cleared — v1 ships public-domain scripture (WEB default, KJV secondary). Public release now waits only on the mechanical yellows (privacy URL, icon, screenshots) plus Greg's signing clicks.
