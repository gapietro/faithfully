...
**Installed.** `Faithfully/Resources/Assets.xcassets/AppIcon.appiconset/AppIcon.png` is Greg-selected Recraft v3 (open book + gold cross). Candidates under `docs/ship/icons/`.
